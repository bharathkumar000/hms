...
import styles from './dispensing.module.css';
...
export default function PharmacyDispensing() {
  ...
  const handleDispense = async (e: React.FormEvent) => {
    ...
    setShowModal(false);
    fetchPrescriptions();
    showAlert('Medicine dispensed and billed successfully!');
  };
  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <div>
          <h1 className={styles.title}>Prescription Dispensing</h1>
          <p className={styles.details}>Process active prescriptions, check stock, and dispense medicines.</p>
        </div>
      </header>
